...
items = [Item(0, 50, 50, 7, 20),
         ...
         Item(5, 50, 300, 7, 30),
         Item(6, 50, 350, 7, 100)]
bins = [Bin(400, 50, 22, 100, (0, 0, 0), 0),
        Bin(450, 50, 22, 100, (0, 0, 0), 1),
        Bin(500, 50, 22, 100, (0, 0, 0), 2),
        Bin(550, 50, 22, 100, (0, 0, 0), 3)]
...
solve_genetic_img = pygame.image.load('assets/solve_btn.png')
